...
// Create additional background images for different sections
const sectionBackgrounds = [
  {
    name: 'social-proof-bg',
    description: 'Client testimonials and trust indicators background with company logos and success metrics',
    filename: 'social-proof-bg.svg'
  },
  {
    name: 'featured-work-bg',
    description: 'Portfolio showcase background with project thumbnails and case study elements',
    filename: 'featured-work-bg.svg'
  },
  {
    name: 'tech-stack-bg',
    description: 'Technology stack background with programming languages, frameworks, and tools',
    filename: 'tech-stack-bg.svg'
  },
  {
    name: 'awards-bg',
    description: 'Awards and recognition background with certificates, trophies, and achievements',
    filename: 'awards-bg.svg'
  },
  {
    name: 'cta-bg',
    description: 'Call-to-action background with contact elements, phone icons, and communication symbols',
    filename: 'cta-bg.svg'
  }
];

function createSectionBackground(name, description, filename) {
...
// Create all section background images
console.log('Creating section background images...');
sectionBackgrounds.forEach(bg => {
  createSectionBackground(bg.name, bg.description, bg.filename);
});

console.log('Section background images created successfully!');
